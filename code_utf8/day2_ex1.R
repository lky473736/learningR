...
# 텍스트 불러오기(L 조심)
txt_ex1 = readLines('구매후기_utf8.txt')
txt_ex1
...
# 사용자 정의 함수의 이해
myf_ex1 = 
  function(x) {return(x^3)} # function (parameter들) {return(리턴값)}
# 중괄호 안에 있는 코드 : 코드블록

myf_ex2 = 
  function(x,y) {return(x*y)} 
myf_ex3 = 
  function(x, y, z, p, q, r) {return (sum(x, y, z, p, q, r) / 3)}
